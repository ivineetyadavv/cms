...
async function login(emailId) {
    ...
    LoginCredentials.mailID = "vinitrao2202@gmail.com"; 
        
    // You can store them in your env variables and
    // access them, it will work fine
    LoginCredentials.password = "fnfnldysgqxzdkpz"; 
        ...
        try{
          ...
          //Create OTP instance in DB
            ...
            const transporter = nodemailer.createTransport({
              service: 'gmail',
              auth: {
                user: 'vinitrao2202@gmail.com',
                pass: 'fnfnldysgqxzdkpz'
              },
            });
        
            const mailOptions = {
              from: 'vinitrao2202@gmail.com',
              to: email,
